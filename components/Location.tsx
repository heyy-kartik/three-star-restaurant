        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          >
            <div className="bg-gradient-to-br from-orange-50 to-white p-8 rounded-lg shadow-lg">
              ...
              <div className="space-y-4 gap-5 flex flex-col sm:flex-row sm:space-y-0 sm:space-x-4">
                <Button onClick={getDirections} className="w-[200px]">
                  <Navigation className="w-5 h-5 mr-2" />
                  Get Directions
                </Button>

                <Button onClick={openInMaps} className="w-[200px]">
